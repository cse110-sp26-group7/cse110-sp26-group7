...
// Symbol pool for slot reels
const symbols = ['🤖', '💾', '🧠', '⚙️', '🔌', '💻'];

// Roast messages for loss outcomes
const roasts = [
...
// Roast messages for win outcomes
const winRoasts = [
...
// Roast messages for jackpot outcomes
const jackpotRoasts = [
...
// Execute a spin if not already spinning
function spin() {
...
// Complete the spin animation and determine win/loss
...
// Check for winning combinations and apply payouts and sounds
...
function resetGame() {
    ...
    // Reset reel displays and remove spinning class
    gameState.elements.reel1.textContent = '🤖';
    gameState.elements.reel2.textContent = '🤖';
    gameState.elements.reel3.textContent = '🤖';
    gameState.elements.reel1.classList.remove('spinning');
    gameState.elements.reel2.classList.remove('spinning');
    gameState.elements.reel3.classList.remove('spinning');
...
// Generate a rising tick sound that loops during spin
...
// Generate a fanfare chord for jackpot wins
...
// Generate a cheerful rising tone for partial wins
...
// Generate a descending sad tone for losses
...
// Generate a click sound for button presses
